		...
		<fieldset>
			...
			<div class="form-group my-3">
				<label for="iId" class="form-label">Id:</label> <input
					type="text" id="iId" name="nId" class="form-control" value="${empresa.id }" required readonly />
			</div>
			<div class="form-group my-3">
				<label for="iNome" class="form-label">Nome:</label> <input
					type="text" id="iNome" name="nNome" class="form-control" value="${empresa.nome }"  required />
			</div>

			<div class="form-group my-3">
				<label for="iCnpj" class="form-label">CNPJ:</label> <input type="text"
					id="iCnpj" name="nCNPJ" class="form-control" maxLength="14" value="${empresa.cnpj }"  required/>
			</div>

			<div class="form-group my-3">
				<label for="iEmail" class="form-label">Email:</label> <input
					type="text" id="iEmail" name="nEmail" class="form-control" value="${empresa.email }"  required/>
			</div>

			<div class="form-group my-3">
				<label for="iTelefone" class="form-label">Telefone:</label> <input
					type="text" id="iTelefone" name="nTelefone" class="form-control" maxLength="11" value="${empresa.telefone }"  required/>
			</div>
			
			<div class="form-group my-3">
				<label for="iVagas" class="form-label">Vagas Disponíveis:</label> <input
					type="text" id="iVagas" name="nVagas" class="form-control" value="${empresa.vagas }"  required/>
			</div>
		...
		<fieldset>
			...
			<div class="form-group my-3">
				<label for="iCep" class="form-label">CEP:</label> <input type="text"
					id="iCep" name="nCep" class="form-control" maxLength="9" value="${empresa.cep }"  required/>
			</div>

			<div class="form-group my-3">
				<label for="iEndereco" class="form-label">Endereço:</label> <input
					type="text" id="iEndereco" name="nEndereco" class="form-control" value="${empresa.endereco }"  required/>
			</div>

			<div class="form-group my-3">
				<label for="iEstado" class="form-label">Estado:</label> <input
					type="text" id="iEstado" name="nEstado" class="form-control"
					placeholder="GO, DF, MT, AM, CE..." maxLength="2" value="${empresa.estado }"  required/>
			</div>

			<div class="form-group my-3">
				<label for="iCidade" class="form-label">Cidade:</label> <input
					type="text" id="iCidade" name="nCidade" class="form-control" value="${empresa.cidade }"  required/>
			</div>
		</fieldset>
